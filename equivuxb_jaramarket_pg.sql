...
DELETE FROM "users";
DELETE FROM "ingredient_state_prices";
DELETE FROM "ingredient_product";
DELETE FROM "product_state_prices";
DELETE FROM "lgas";
...
INSERT INTO "admins" ("id", "name", "email", "password", "phone", "is_active", "email_verified_at", "last_login_at", "remember_token", "created_at", "updated_at") VALUES
  (1, 'Ime Iteh', 'iteleh97@gmail.com', '$2y$12$AQ/desIhGL.uY6EBHWSkJOE9EaZ0yPtZKV8CJe2TO217T9Y3H.vYu', '07068628887', true, '2025-06-01 08:53:00', '2025-06-01 08:53:00', NULL, '2025-06-01 08:53:00', '2025-06-01 08:53:00');

-- advertisements: 1 rows
...
-- countries: 238 rows
INSERT INTO "countries" ("id", "name", "code", "created_at", "updated_at", "vat") VALUES
  (1, 'África do Sul', '', NULL, NULL, 0.00),
  (2, 'Áustria', '', NULL, NULL, 0.00),
  (3, 'Índia', '', NULL, NULL, 0.00),
  (4, 'Afeganistão', '', NULL, NULL, 0.00),
  (5, 'Albânia', '', NULL, NULL, 0.00),
  (6, 'Alemanha', '', NULL, NULL, 0.00),
  (7, 'Andorra', '', NULL, NULL, 0.00),
  (8, 'Angola', '', NULL, NULL, 0.00),
  (9, 'Anguila', '', NULL, NULL, 0.00),
  (10, 'Antárctida', '', NULL, NULL, 0.00),
  (11, 'Antígua e Barbuda', '', NULL, NULL, 0.00),
  (12, 'Antilhas Neerlandesas', '', NULL, NULL, 0.00),
  (13, 'Arábia Saudita', '', NULL, NULL, 0.00),
  (14, 'Argélia', '', NULL, NULL, 0.00),
  (15, 'Argentina', '', NULL, NULL, 0.00),
  (16, 'Arménia', '', NULL, NULL, 0.00),
  (17, 'Aruba', '', NULL, NULL, 0.00),
  (18, 'Austrália', '', NULL, NULL, 0.00),
  (19, 'Azerbaijão', '', NULL, NULL, 0.00),
  (20, 'Bélgica', '', NULL, NULL, 0.00),
  (21, 'Bósnia e Herzegovina', '', NULL, NULL, 0.00),
  (22, 'Baamas', '', NULL, NULL, 0.00),
  (23, 'Bangladeche', '', NULL, NULL, 0.00),
  (24, 'Barém', '', NULL, NULL, 0.00),
  (25, 'Barbados', '', NULL, NULL, 0.00),
  (26, 'Belize', '', NULL, NULL, 0.00),
  (27, 'Benim', '', NULL, NULL, 0.00),
  (28, 'Bermudas', '', NULL, NULL, 0.00),
  (29, 'Bielorrússia', '', NULL, NULL, 0.00),
  (30, 'Birmânia', '', NULL, NULL, 0.00),
  (31, 'Bolívia', '', NULL, NULL, 0.00),
  (32, 'Botsuana', '', NULL, NULL, 0.00),
  (33, 'Brasil', '', NULL, NULL, 0.00),
  (34, 'Brunei', '', NULL, NULL, 0.00),
  (35, 'Bulgária', '', NULL, NULL, 0.00),
  (36, 'Burúndi', '', NULL, NULL, 0.00),
  (37, 'Burquina Faso', '', NULL, NULL, 0.00),
  (38, 'Butão', '', NULL, NULL, 0.00),
  (39, 'Cabo Verde', '', NULL, NULL, 0.00),
  (40, 'Camarões', '', NULL, NULL, 0.00),
  (41, 'Camboja', '', NULL, NULL, 0.00),
  (42, 'Canadá', '', NULL, NULL, 0.00),
  (43, 'Catar', '', NULL, NULL, 0.00),
  (44, 'Cazaquistão', '', NULL, NULL, 0.00),
  (45, 'Chade', '', NULL, NULL, 0.00),
  (46, 'Chile', '', NULL, NULL, 0.00),
  (47, 'China', '', NULL, NULL, 0.00),
  (48, 'Chipre', '', NULL, NULL, 0.00),
  (49, 'Colômbia', '', NULL, NULL, 0.00),
  (50, 'Comores', '', NULL, NULL, 0.00),
  (51, 'Congo-Brazzaville', '', NULL, NULL, 0.00),
  (52, 'Congo-Kinshasa', '', NULL, NULL, 0.00),
  (53, 'Coreia do Norte', '', NULL, NULL, 0.00),
  (54, 'Coreia do Sul', '', NULL, NULL, 0.00),
  (55, 'Costa Rica', '', NULL, NULL, 0.00),
  (56, 'Costa do Marfim', '', NULL, NULL, 0.00),
  (57, 'Croácia', '', NULL, NULL, 0.00),
  (58, 'Cuba', '', NULL, NULL, 0.00),
  (59, 'Dinamarca', '', NULL, NULL, 0.00),
  (60, 'Domínica', '', NULL, NULL, 0.00),
  (61, 'Egipto', '', NULL, NULL, 0.00),
  (62, 'Emiratos Árabes Unidos', '', NULL, NULL, 0.00),
  (63, 'Equador', '', NULL, NULL, 0.00),
  (64, 'Eritreia', '', NULL, NULL, 0.00),
  (65, 'Eslováquia', '', NULL, NULL, 0.00),
  (66, 'Eslovénia', '', NULL, NULL, 0.00),
  (67, 'Espanha', '', NULL, NULL, 0.00),
  (68, 'Estónia', '', NULL, NULL, 0.00),
  (69, 'Estados Unidos', '', NULL, NULL, 0.00),
  (70, 'Etiópia', '', NULL, NULL, 0.00),
  (71, 'Faroé', '', NULL, NULL, 0.00),
  (72, 'Fiji', '', NULL, NULL, 0.00),
  (73, 'Filipinas', '', NULL, NULL, 0.00),
  (74, 'Finlândia', '', NULL, NULL, 0.00),
  (75, 'França', '', NULL, NULL, 0.00),
  (76, 'Gâmbia', '', NULL, NULL, 0.00),
  (77, 'Gabão', '', NULL, NULL, 0.00),
  (78, 'Gana', '', NULL, NULL, 0.00),
  (79, 'Geórgia', '', NULL, NULL, 0.00),
  (80, 'Geórgia do Sul e Sandwich do Sul', '', NULL, NULL, 0.00),
  (81, 'Gibraltar', '', NULL, NULL, 0.00),
  (82, 'Grécia', '', NULL, NULL, 0.00),
  (83, 'Granada', '', NULL, NULL, 0.00),
  (84, 'Gronelândia', '', NULL, NULL, 0.00),
  (85, 'Guadalupe', '', NULL, NULL, 0.00),
  (86, 'Guame', '', NULL, NULL, 0.00),
  (87, 'Guatemala', '', NULL, NULL, 0.00),
  (88, 'Guiana', '', NULL, NULL, 0.00),
  (89, 'Guiana Francesa', '', NULL, NULL, 0.00),
  (90, 'Guiné', '', NULL, NULL, 0.00),
  (91, 'Guiné Equatorial', '', NULL, NULL, 0.00),
  (92, 'Guiné-Bissau', '', NULL, NULL, 0.00),
  (93, 'Haiti', '', NULL, NULL, 0.00),
  (94, 'Honduras', '', NULL, NULL, 0.00),
  (95, 'Hong Kong', '', NULL, NULL, 0.00),
  (96, 'Hungria', '', NULL, NULL, 0.00),
  (97, 'Iémen', '', NULL, NULL, 0.00),
  (98, 'Ilha Bouvet', '', NULL, NULL, 0.00),
  (99, 'Ilha Norfolk', '', NULL, NULL, 0.00),
  (100, 'Ilha do Natal', '', NULL, NULL, 0.00),
  (101, 'Ilhas Caimão', '', NULL, NULL, 0.00),
  (102, 'Ilhas Cook', '', NULL, NULL, 0.00),
  (103, 'Ilhas Falkland', '', NULL, NULL, 0.00),
  (104, 'Ilhas Heard e McDonald', '', NULL, NULL, 0.00),
  (105, 'Ilhas Marshall', '', NULL, NULL, 0.00),
  (106, 'Ilhas Menores Distantes dos Estados Unidos', '', NULL, NULL, 0.00),
  (107, 'Ilhas Salomão', '', NULL, NULL, 0.00),
  (108, 'Ilhas Turcas e Caicos', '', NULL, NULL, 0.00),
  (109, 'Ilhas Virgens Americanas', '', NULL, NULL, 0.00),
  (110, 'Ilhas Virgens Britânicas', '', NULL, NULL, 0.00),
  (111, 'Ilhas dos Cocos', '', NULL, NULL, 0.00),
  (112, 'Indonésia', '', NULL, NULL, 0.00),
  (113, 'Irão', '', NULL, NULL, 0.00),
  (114, 'Iraque', '', NULL, NULL, 0.00),
  (115, 'Irlanda', '', NULL, NULL, 0.00),
  (116, 'Islândia', '', NULL, NULL, 0.00),
  (117, 'Israel', '', NULL, NULL, 0.00),
  (118, 'Itália', '', NULL, NULL, 0.00),
  (119, 'Jamaica', '', NULL, NULL, 0.00),
  (120, 'Japão', '', NULL, NULL, 0.00),
  (121, 'Jibuti', '', NULL, NULL, 0.00),
  (122, 'Jordânia', '', NULL, NULL, 0.00),
  (123, 'Jugoslávia', '', NULL, NULL, 0.00),
  (124, 'Kuwait', '', NULL, NULL, 0.00),
  (125, 'Líbano', '', NULL, NULL, 0.00),
  (126, 'Líbia', '', NULL, NULL, 0.00),
  (127, 'Laos', '', NULL, NULL, 0.00),
  (128, 'Lesoto', '', NULL, NULL, 0.00),
  (129, 'Letónia', '', NULL, NULL, 0.00),
  (130, 'Libéria', '', NULL, NULL, 0.00),
  (131, 'Listenstaine', '', NULL, NULL, 0.00),
  (132, 'Lituânia', '', NULL, NULL, 0.00),
  (133, 'Luxemburgo', '', NULL, NULL, 0.00),
  (134, 'México', '', NULL, NULL, 0.00),
  (135, 'Mónaco', '', NULL, NULL, 0.00),
  (136, 'Macau', '', NULL, NULL, 0.00),
  (137, 'Macedónia', '', NULL, NULL, 0.00),
  (138, 'Madagáscar', '', NULL, NULL, 0.00),
  (139, 'Malásia', '', NULL, NULL, 0.00),
  (140, 'Malávi', '', NULL, NULL, 0.00),
  (141, 'Maldivas', '', NULL, NULL, 0.00),
  (142, 'Mali', '', NULL, NULL, 0.00),
  (143, 'Malta', '', NULL, NULL, 0.00),
  (144, 'Marianas do Norte', '', NULL, NULL, 0.00),
  (145, 'Marrocos', '', NULL, NULL, 0.00),
  (146, 'Martinica', '', NULL, NULL, 0.00),
  (147, 'Maurícia', '', NULL, NULL, 0.00),
  (148, 'Mauritânia', '', NULL, NULL, 0.00),
  (149, 'Mayotte', '', NULL, NULL, 0.00),
  (150, 'Micronésia', '', NULL, NULL, 0.00),
  (151, 'Moçambique', '', NULL, NULL, 0.00),
  (152, 'Moldávia', '', NULL, NULL, 0.00),
  (153, 'Mongólia', '', NULL, NULL, 0.00),
  (154, 'Monserrate', '', NULL, NULL, 0.00),
  (155, 'Níger', '', NULL, NULL, 0.00),
  (156, 'Namíbia', '', NULL, NULL, 0.00),
  (157, 'Nauru', '', NULL, NULL, 0.00),
  (158, 'Nepal', '', NULL, NULL, 0.00),
  (159, 'Nicarágua', '', NULL, NULL, 0.00),
  (160, 'Nigéria', '', NULL, NULL, 0.00),
  (161, 'Niue', '', NULL, NULL, 0.00),
  (162, 'Noruega', '', NULL, NULL, 0.00),
  (163, 'Nova Caledónia', '', NULL, NULL, 0.00),
  (164, 'Nova Zelândia', '', NULL, NULL, 0.00),
  (165, 'Omã', '', NULL, NULL, 0.00),
  (166, 'Países Baixos', '', NULL, NULL, 0.00),
  (167, 'Palau', '', NULL, NULL, 0.00),
  (168, 'Panamá', '', NULL, NULL, 0.00),
  (169, 'Papua-Nova Guiné', '', NULL, NULL, 0.00),
  (170, 'Paquistão', '', NULL, NULL, 0.00),
  (171, 'Paraguai', '', NULL, NULL, 0.00),
  (172, 'Peru', '', NULL, NULL, 0.00),
  (173, 'Pitcairn', '', NULL, NULL, 0.00),
  (174, 'Polónia', '', NULL, NULL, 0.00),
  (175, 'Polinésia Francesa', '', NULL, NULL, 0.00),
  (176, 'Porto Rico', '', NULL, NULL, 0.00),
  (177, 'Portugal', '', NULL, NULL, 0.00),
  (178, 'Quénia', '', NULL, NULL, 0.00),
  (179, 'Quirguizistão', '', NULL, NULL, 0.00),
  (180, 'Quiribáti', '', NULL, NULL, 0.00),
  (181, 'Rússia', '', NULL, NULL, 0.00),
  (182, 'Reino Unido', '', NULL, NULL, 0.00),
  (183, 'República Centro-Africana', '', NULL, NULL, 0.00),
  (184, 'República Checa', '', NULL, NULL, 0.00),
  (185, 'República Dominicana', '', NULL, NULL, 0.00),
  (186, 'Reunião', '', NULL, NULL, 0.00),
  (187, 'Roménia', '', NULL, NULL, 0.00),
  (188, 'Ruanda', '', NULL, NULL, 0.00),
  (189, 'São Cristóvão e Neves', '', NULL, NULL, 0.00),
  (190, 'São Marinho', '', NULL, NULL, 0.00),
  (191, 'São Pedro e Miquelon', '', NULL, NULL, 0.00),
  (192, 'São Tomé e Príncipe', '', NULL, NULL, 0.00),
  (193, 'São Vicente e Granadinas', '', NULL, NULL, 0.00),
  (194, 'Síria', '', NULL, NULL, 0.00),
  (195, 'Salvador', '', NULL, NULL, 0.00),
  (196, 'Samoa', '', NULL, NULL, 0.00),
  (197, 'Samoa Americana', '', NULL, NULL, 0.00),
  (198, 'Santa Helena', '', NULL, NULL, 0.00),
  (199, 'Santa Lúcia', '', NULL, NULL, 0.00),
  (200, 'Sara Ocidental', '', NULL, NULL, 0.00),
  (201, 'Seicheles', '', NULL, NULL, 0.00),
  (202, 'Senegal', '', NULL, NULL, 0.00),
  (203, 'Serra Leoa', '', NULL, NULL, 0.00),
  (204, 'Singapura', '', NULL, NULL, 0.00),
  (205, 'Somália', '', NULL, NULL, 0.00),
  (206, 'Sri Lanca', '', NULL, NULL, 0.00),
  (207, 'Suécia', '', NULL, NULL, 0.00),
  (208, 'Suíça', '', NULL, NULL, 0.00),
  (209, 'Suazilândia', '', NULL, NULL, 0.00),
  (210, 'Sudão', '', NULL, NULL, 0.00),
  (211, 'Suriname', '', NULL, NULL, 0.00),
  (212, 'Svalbard e Jan Mayen', '', NULL, NULL, 0.00),
  (213, 'Tailândia', '', NULL, NULL, 0.00),
  (214, 'Taiwan', '', NULL, NULL, 0.00),
  (215, 'Tajiquistão', '', NULL, NULL, 0.00),
  (216, 'Tanzânia', '', NULL, NULL, 0.00),
  (217, 'Território Britânico do Oceano Índico', '', NULL, NULL, 0.00),
  (218, 'Territórios Austrais Franceses', '', NULL, NULL, 0.00),
  (219, 'Timor Leste', '', NULL, NULL, 0.00),
  (220, 'Togo', '', NULL, NULL, 0.00),
  (221, 'Tokelau', '', NULL, NULL, 0.00),
  (222, 'Tonga', '', NULL, NULL, 0.00),
  (223, 'Trindade e Tobago', '', NULL, NULL, 0.00),
  (224, 'Tunísia', '', NULL, NULL, 0.00),
  (225, 'Turquemenistão', '', NULL, NULL, 0.00),
  (226, 'Turquia', '', NULL, NULL, 0.00),
  (227, 'Tuvalu', '', NULL, NULL, 0.00),
  (228, 'Ucrânia', '', NULL, NULL, 0.00),
  (229, 'Uganda', '', NULL, NULL, 0.00),
  (230, 'Uruguai', '', NULL, NULL, 0.00),
  (231, 'Usbequistão', '', NULL, NULL, 0.00),
  (232, 'Vanuatu', '', NULL, NULL, 0.00),
  (233, 'Vaticano', '', NULL, NULL, 0.00),
  (234, 'Venezuela', '', NULL, NULL, 0.00),
  (235, 'Vietname', '', NULL, NULL, 0.00),
  (236, 'Wallis e Futuna', '', NULL, NULL, 0.00),
  (237, 'Zâmbia', '', NULL, NULL, 0.00),
  (238, 'Zimbábue', '', NULL, NULL, 0.00);
...
INSERT INTO "ingredients" ("id", "category_id", "name", "description", "price", "discounted_price", "unit", "stock", "image_url", "created_at", "updated_at") VALUES
  ...
  (2, NULL, 'Cray Fish', 'Freshly Smoked Crayfish', 500.00, 500.00, 'por', 200, 'ingredients/1768223637_cray_fish_small.jpeg', '2025-05-13 15:09:56', '2026-01-12 18:13:57'),
  (3, NULL, 'Red Oil', 'Oil', 1800.00, 1750.00, 'l', 100, 'ingredients/1768224771_red_oil.jpg', '2025-06-01 09:47:52', '2026-01-12 18:32:51'),
  (4, NULL, 'Pepper', 'Fresh Pepper', 500.00, 0.00, 'por', 100, 'ingredients/1768224572_pepper.jpg', '2025-09-11 07:34:40', '2026-01-12 18:29:32'),
  (5, 7, 'Okro', 'Okra', 500.00, 500.00, 'por', 1990, 'ingredients/1768227586_okro.jpeg', '2026-01-12 19:19:46', '2026-01-12 19:19:46'),
  (6, NULL, 'Melon', 'Fresh Melon', 700.00, NULL, 'cup', 1000, 'ingredients/1768379858_EGUSI.jpg', '2026-01-14 13:37:38', '2026-01-14 13:37:38'),
  (7, NULL, 'Chicken Part', 'Fresh Chicken', 1500.00, 1450.00, 'kg', 1333, 'ingredients/1768823979_chicken_part.jpg', '2026-01-19 16:59:39', '2026-01-19 16:59:39'),
  ...
  (9, NULL, 'Olive Oil', 'original oil', 3500.00, NULL, 'l', 122, 'ingredients/1768824445_sachet_oil.jpeg', '2026-01-19 17:07:25', '2026-01-19 17:07:25'),
  ...
  (14, NULL, 'Maggi', 'Good,  recommended in various delicacies', 500.00, 490.00, 'g', 5, 'ingredients/1774374135_images_(1).jpeg', '2026-03-24 21:42:15', '2026-03-24 21:42:15'),
  ...
  (16, NULL, 'Curry powder', NULL, 50.00, NULL, 'tsp', 20, 'ingredients/1775045750_81wnKR6DEfL._AC_UF894,1000_QL80_.jpg', '2026-04-01 15:42:24', '2026-04-01 16:15:50'),
  (17, NULL, 'Salt', NULL, 1200.00, NULL, 'kg', 20, 'ingredients/1775045329_Dangote-Salt-1kg.png', '2026-04-01 16:08:49', '2026-04-01 16:13:33'),
  ...
  (20, NULL, 'Bouillon powder', NULL, 2000.00, NULL, 'g', 20, 'ingredients/1775045988_chicken-bouillon-powder.png', '2026-04-01 16:19:48', '2026-04-01 16:19:48'),
  ...
  (31, NULL, 'Ginger', NULL, 200.00, NULL, 'por', 20, 'ingredients/1775051911_a-fresh-ginger-root-with-a-knobby-tan-surface-and-a-textured-appearance-png.png', '2026-04-01 17:58:31', '2026-04-01 20:02:11'),
...
-- ingredient_state_prices: 3 rows
...
-- users: 18 rows
INSERT INTO "users" ("id", "firstname", "lastname", "password", "email", "phone_number", "role", "profile_picture", "country_id", "business_name", "business_address", "shop_size", "payment_method", "fcm_token", "latitude", "longitude", "email_verified_at", "referral_code", "referrer_id", "referral_count", "is_active", "is_verified", "pin", "bank_name", "bank_code", "recipient_code", "account_number", "account_name", "last_login", "created_at", "updated_at", "deleted_at", "state_id", "lga_id", "is_staff", "is_superuser") VALUES
  (1, 'Ndueso', 'Walter', '$2y$12$/CDXAME3UCsxgdCX9KIMGuOHfBkXQNIdrHZw1QZPF2lRLr/7Lx1HO', 'iteleh97@gmail.com', '07068628887', 'vendor', '/storage/Users/1748789785_Screenshot from 2025-05-26 22-43-20.png', 4, 'Geitel Solution', 'Uyo', 'just_me', NULL, NULL, 6.2345000, 3.3321000, '2025-05-29 07:34:55', 'PXWqUPAQ96', NULL, 0, true, false, NULL, 'Opay', NULL, NULL, '7068628887', 'Ime Sunday Iteh', '2026-04-13 13:19:08', '2025-05-26 15:06:29', '2026-04-22 19:39:09', NULL, NULL, NULL, false, false),
  (3, 'Ndueso', 'Walter', '$2y$12$q6sMgUlrkZJEd8kCuqdsZelMRwZOWvK8EzQh7MAImcEysn0i/MuX6', 'iteleh99@gmail.com', '07068628887', 'customer', NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-11 17:55:49', 'YkgD2BQA3n', 1, 1, true, false, NULL, 'OPay Digital Services Limited (OPay)', '999992', NULL, '7068628887', 'Ime Sunday Iteh', '2026-04-11 14:38:36', '2025-09-10 05:05:21', '2026-04-11 18:38:36', NULL, NULL, NULL, false, false),
  (7, 'Ime', 'Iteh', '$2y$12$HGcsIm1QthV9f5MkQMc6juw7QhrIIZvUgBAE/klwIbQe9XOGXy6TG', 'iteleh101@gmail.com', '07068628877', 'vendor', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-04 16:34:09', 'C8AJUEUpuJ', NULL, 0, true, false, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-04 11:35:39', '2026-01-04 16:23:12', '2026-01-05 20:24:48', NULL, NULL, NULL, false, false),
  (9, 'Dan', 'Ekwere', '$2y$12$nBWmGIJBTdcl.wT11jX9R.QSrlM7QgmA0so/AA8OWoQYRndz.fQjO', 'danielekwere99@gmail.com', '+234 704 319 4111', 'vendor', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-09 03:40:25', 'yUek2MdERf', NULL, 0, true, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-06 15:37:25', '2026-01-09 03:40:25', NULL, NULL, NULL, false, false),
  (10, 'Daniel', 'Ekwere', '$2y$12$C9Gbo6JQUM4RfYSE5IX//uyHzUv4lFXyMLWLpgRNfooutDVsEZIIy', 'ekweredaniel8@gmail.com', '07043194111', 'vendor', NULL, NULL, 'danTech Stores', NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-21 19:51:59', 'hV91tUZ6xD', NULL, 0, true, false, '$2y$12$bHk/TJhbNhJcEIpFOFUhbe1h9IEKnaM55V08R1D8GMoooqnSgVygS', NULL, NULL, NULL, NULL, NULL, '2026-03-20 19:03:16', '2026-01-06 20:07:07', '2026-04-21 19:52:13', NULL, NULL, NULL, false, false),
  (11, 'lucy', 'William', '$2y$12$BZ7Dpi.gFuVRjE2TbzkmbehxCl2h9EjXEnouT81af/mTgjTQRMd/W', 'ekweredaniel91@gmail.com', '07070747614', 'customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'VfeZocfaAu', NULL, 0, false, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-09 03:44:24', '2026-01-09 03:44:24', NULL, NULL, NULL, false, false),
  (13, 'walter', 'winson', '$2y$12$4.zwukjvBIdjF1m5ur7CtegRvE32.ZAZRU0wn5f3IZzaJVi5P.MFy', 'walterwinston877@gmail.com', '05045368855', 'customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-12 17:10:24', '7E5YitaDoD', NULL, 0, true, false, NULL, NULL, NULL, NULL, NULL, NULL, '2026-01-12 12:37:23', '2026-01-12 17:07:54', '2026-01-12 17:37:23', NULL, NULL, NULL, false, false),
  (17, 'peter', 'usem', '$2y$12$mU/0uDJOwgpRhObeqGcw/.LArVW9lfE.fQTwc4kfze/QENG6013j.', 'peter12@gmail.com', '080333344999', 'customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'MIe4u9mWmq', NULL, 0, false, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-27 14:01:05', '2026-02-27 14:01:05', NULL, NULL, NULL, false, false),
  (18, 'Victor', 'akpan', '$2y$12$ysMViN5jgVEI36DKJcUA1uDu3mehqjOQvYJ3JSoQpasDNsVYZbz/y', 'victorpee40@gmail.com', '08039453216', 'vendor', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-22 21:50:53', 'PD7EtHicxX', NULL, 0, true, false, NULL, NULL, NULL, NULL, NULL, NULL, '2026-02-27 09:38:40', '2026-02-27 14:37:50', '2026-04-22 21:50:53', NULL, NULL, NULL, false, false),
  (20, 'Seasons', 'Farms', '$2y$12$TTdhRJjs8W2nwmr4ZwzjWuPGD1.e/zJwd1dYrtceNFUTa3yUcBKxa', 'seasonfarmsandfood@gmail.com', '08069468545', 'customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'YT5PEH0pFv', NULL, 0, false, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-03-23 12:15:44', '2026-03-23 12:15:44', NULL, NULL, NULL, false, false),
  (26, 'moses', 'denis', '$2y$12$ZEZg1FzsIfvoKzYbuKZYiu5QIh5fOQTMAX05GLNgUn6fxZ8vH/JfG', 'danielekwere2023@gmail.com', NULL, 'customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'DFpqZp4q88', NULL, 0, true, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-03-24 19:16:56', '2026-03-24 19:19:49', NULL, NULL, NULL, false, false),
  (27, 'Mfonobong', 'Wilson', '$2y$12$BCHO0e1.dgu1vFirjJy/CujKoN9UWHzB2xCyxSSt2jQd4j1OtLmiG', 'jaramarket0@gmail.com', '07067262338', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-03-24 19:25:53', 'Zq4WJ2i2NL', NULL, 0, true, false, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-24 13:33:44', '2026-03-24 19:25:53', '2026-04-24 17:33:44', NULL, NULL, NULL, false, false),
  (28, 'UtibeAbasi', 'Enoidem', '$2y$12$pYwi9MP2/4HVowxFI3RJQe2K668lWzWK2Umkki.Quu/g.ZW7ZsN.u', 'tidem.a2w@gmail.com', '08064196687', 'customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-01 13:59:35', '5RBk3jMg5f', NULL, 0, true, false, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-01 10:00:22', '2026-04-01 13:57:31', '2026-04-01 14:00:22', NULL, NULL, NULL, false, false),
  (29, 'James', 'James', '$2y$12$qgupKqbXYY7RZCdK65G5T.bCzrbwDVUudQXeoCyPTh886M8Fdz9nu', 'jamesjamesemmanuel81@gmail.com', '08061271438', 'customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'jqts6tqfth', NULL, 0, false, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-14 14:18:14', '2026-04-14 14:18:14', NULL, NULL, NULL, false, false),
  (35, 'Inimfon', 'Udofa', '$2y$12$YUIFTZfdTD8bb0t.Bi5XgeWaAh1ffsS8Z.ysFb1izSlqvrA5fqG9S', 'stenographerservices0@gmail.com', '08100375377', 'vendor', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-21 17:33:15', 'YwuuWbSj0F', NULL, 0, true, false, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-21 13:34:56', '2026-04-21 16:52:53', '2026-04-21 17:34:56', NULL, NULL, NULL, false, false),
  (36, 'Inimfon', 'udofa', '$2y$12$pCQ0UqX6Jio2qOwQ2ZypYOhlSi65/9g95Ny3Lmju8umo0rauY0gWm', 'iudofa0@gmail.com', '07011487158', 'vendor', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-21 18:26:06', 'DKPef3T9NG', NULL, 0, true, false, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-21 14:56:12', '2026-04-21 18:22:25', '2026-04-21 18:56:12', NULL, NULL, NULL, false, false),
  (37, 'theodore', 'desmond', '$2y$12$M12qgifdjgo27czxp9AMQet6BmGkE/poHTVlBaWyBX8axqWGjwYfi', 'desmondtheodore94@gmail.com', '09032456432', 'vendor', NULL, NULL, 'myStore', 'akpan andem market.', '2-5', 'offline', NULL, NULL, NULL, '2026-04-22 19:45:25', '94RPY0wxEI', NULL, 0, true, false, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-22 15:47:10', '2026-04-22 19:42:27', '2026-04-22 19:47:10', NULL, NULL, NULL, false, false),
  (-1, 'Deleted', 'Account', '!unusable-password', 'deleted-user@placeholder.invalid', NULL, 'customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, false, false, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, false, false);
...
INSERT INTO "addresses" ("id", "user_id", "country_id", "state_id", "lga_id", "contact_address", "phone_number", "is_default", "created_at", "updated_at") VALUES
  (1, 1, 15, 4, 19, 'Akpa Ube closed', '07068628887', true, '2025-05-30 23:48:17', '2025-05-30 23:49:55'),
  (2, 10, 160, 4, 69, 'Asian obufa', '07043194111', true, '2026-01-06 20:13:37', '2026-01-06 20:13:37'),
  (3, 13, 160, 4, 91, 'nepa line', '07043184111', true, '2026-01-12 17:45:26', '2026-01-12 17:45:26'),
  (4, -1, 160, 4, 69, 'nwanniba', '07043194111', false, '2026-02-14 13:55:35', '2026-02-14 13:55:35'),
  (5, 28, 160, 4, 91, 'Ifa ikot okpon', '08064196687', false, '2026-04-02 13:39:43', '2026-04-02 13:39:45'),
  (6, 28, 160, 4, 91, 'Ifa ikot okpon', '08064196687', true, '2026-04-02 13:39:45', '2026-04-02 13:39:45'),
  (7, -1, 32, 4, 63, '5 bro street', '08039543321', false, '2026-04-06 19:39:21', '2026-04-06 19:39:21'),
  (8, -1, 160, 4, 91, 'plot 63 , ebiye estate', '08088884983', false, '2026-04-20 03:10:44', '2026-04-20 03:10:44');

-- category_user: 10 rows
INSERT INTO "category_user" ("id", "user_id", "category_id", "created_at", "updated_at") VALUES
  (4, -1, 18, '2026-02-24 00:26:23', '2026-02-24 00:26:23'),
  (5, -1, 7, '2026-02-24 00:26:23', '2026-02-24 00:26:23'),
  (6, -1, 20, '2026-02-24 00:26:23', '2026-02-24 00:26:23'),
  (7, -1, 19, '2026-02-24 00:26:23', '2026-02-24 00:26:23'),
  (9, -1, 18, '2026-02-28 15:47:55', '2026-02-28 15:47:55'),
  (10, -1, 7, '2026-02-28 15:47:55', '2026-02-28 15:47:55'),
...
Return file URLs in the resource response', 'help-tickets/1771766783_Gideon_John_CO.jpeg', 'open', '2026-02-22 18:26:23', '2026-02-22 18:26:23'),
  ...
  (5, -1, 'roiwe', 'wepw0e0wipoer', 'help-tickets/1776708356_featured_asset.png', 'open', '2026-04-20 23:05:56', '2026-04-20 23:05:56');
...
INSERT INTO "wallets" ("id", "user_id", "balance", "created_at", "updated_at") VALUES
  ...
  (4, -1, 260.00, '2025-05-26 07:34:32', '2025-09-11 00:22:52'),
  ...
  (9, -1, 0.00, '2026-01-06 01:27:06', '2026-01-06 01:27:06'),
  ...
  (13, -1, 20000.00, '2026-01-09 03:48:00', '2026-02-28 18:15:53'),
  (14, 13, 0.00, '2026-01-12 17:07:54', '2026-01-12 17:07:54'),
  (15, -1, 0.00, '2026-02-20 08:49:23', '2026-02-20 08:49:23'),
  (16, -1, 0.00, '2026-02-23 23:58:17', '2026-02-23 23:58:17'),
  (17, -1, 20000.00, '2026-02-24 00:01:21', '2026-02-28 21:20:54'),
  (18, 17, 0.00, '2026-02-27 14:01:05', '2026-02-27 14:01:05'),
  (19, 18, 0.00, '2026-02-27 14:37:50', '2026-02-27 14:37:50'),
  (20, -1, 20000.00, '2026-02-28 15:45:39', '2026-03-25 16:34:08'),
  (21, 20, 0.00, '2026-03-23 12:15:44', '2026-03-23 12:15:44'),
  (22, -1, 565500.00, '2026-03-23 12:26:21', '2026-04-10 23:36:56'),
  ...
  (26, -1, 0.00, '2026-04-19 01:45:26', '2026-04-19 01:45:26'),
...
INSERT INTO "orders" ("id", "reference", "order_date", "user_id", "address_id", "delivery_type", "shipping_fee", "service_charge", "vat", "total", "status", "remarks", "audio", "created_at", "updated_at", "deleted_at") VALUES
  ...
  (37, 'JARA_ORD_7266001775247173', '2026-04-03', -1, 1, 'pickup', 2000.00, 1000.00, 0.00, 8000.00, 'pending', 'This is a sample order', NULL, '2026-04-04 00:12:53', '2026-04-04 00:12:53', NULL),
  ...
  (39, 'JARA_ORD_6819681775489972', '2026-04-06', -1, 1, 'pickup', 2000.00, 1000.00, 0.00, 14500.00, 'pending', 'This is a sample order', NULL, '2026-04-06 19:39:32', '2026-04-06 19:39:32', NULL),
  (40, 'JARA_ORD_8330051775514030', '2026-04-06', -1, 1, 'pickup', 2000.00, 1000.00, 0.00, 12000.00, 'pending', 'This is a sample order', NULL, '2026-04-07 02:20:30', '2026-04-07 02:20:30', NULL),
...
INSERT INTO "transaction_logs" ("id", "account_owner_type", "account_owner_id", "owner_type", "owner_id", "reference", "transaction_type", "amount", "old_balance", "new_balance", "status", "currency", "is_refund", "has_refund", "wallet_id", "comment", "created_at", "updated_at") VALUES
  (2, 'App\Models\User', 1, 'App\Models\Order', 2, 'JARA_ORD_2421293242061748688152', 'debit', 5000, 0, -5000, NULL, 'NGN', false, false, 3, NULL, '2025-05-31 10:42:32', '2025-05-31 10:42:32'),
  (3, 'App\Models\User', 1, 'App\Models\Order', 3, 'JARA_ORD_546701270441748688997', 'debit', 5000, -5000, -10000, NULL, 'NGN', false, false, 3, NULL, '2025-05-31 10:56:37', '2025-05-31 10:56:37'),
  (4, 'App\Models\User', 1, 'App\Models\Order', 4, 'JARA_ORD_1148313911241748689289', 'debit', 5000, -10000, -15000, NULL, 'NGN', false, false, 3, NULL, '2025-05-31 11:01:29', '2025-05-31 11:01:29'),
  (5, 'App\Models\User', 1, 'App\Models\Order', 5, 'JARA_ORD_967597435211748689372', 'debit', 5000, -15000, -20000, NULL, 'NGN', false, false, 3, NULL, '2025-05-31 11:02:52', '2025-05-31 11:02:52'),
  (6, 'App\Models\User', 1, 'App\Models\Order', 6, 'JARA_ORD_6328415329781748689433', 'debit', 5000, -20000, -25000, NULL, 'NGN', false, false, 3, NULL, '2025-05-31 11:03:53', '2025-05-31 11:03:53'),
  (7, 'App\Models\User', 1, 'App\Models\Order', 7, 'JARA_ORD_5705160651091748689713', 'debit', 5000, -25000, 5000, NULL, 'NGN', false, false, 3, NULL, '2025-05-31 11:08:33', '2025-05-31 11:08:33'),
  (8, 'App\Models\User', 1, 'App\Models\Order', 2, 'JARA_ORD_8276085398551748694259', 'credit', 5000, 5000, 10000, NULL, 'NGN', true, false, 3, NULL, '2025-05-31 12:24:19', '2025-05-31 12:24:19'),
  (9, 'App\Models\User', 1, 'App\Models\Order', 8, 'JARA_ORD_109533748861748855107', 'debit', 5000, 10000, 5000, NULL, 'NGN', false, false, 3, NULL, '2025-06-02 09:05:07', '2025-06-02 09:05:07'),
  (11, 'App\Models\User', 2, 'App\Models\Order', 7, 'JARA_ORD_2185701757548958', 'credit', 50, 0, 50, NULL, 'NGN', true, false, 4, NULL, '2025-09-11 00:02:38', '2025-09-11 00:02:38'),
  (12, 'App\Models\User', 1, 'App\Models\Order', 2, 'JARA_ORD_5010501757549650', 'credit', 5600, 5000, 10600, NULL, 'NGN', true, false, 3, NULL, '2025-09-11 00:14:10', '2025-09-11 00:14:10'),
  (13, 'App\Models\User', 2, 'App\Models\Order', 2, 'JARA_ORD_5832671757549650', 'credit', 70, 50, 120, NULL, 'NGN', true, false, 4, NULL, '2025-09-11 00:14:10', '2025-09-11 00:14:10'),
  (14, 'App\Models\User', 1, 'App\Models\Order', 2, 'JARA_ORD_7152551757549835', 'credit', 5600, 10600, 16200, NULL, 'NGN', true, false, 3, NULL, '2025-09-11 00:17:15', '2025-09-11 00:17:15'),
  (15, 'App\Models\User', 2, 'App\Models\Order', 2, 'JARA_ORD_1778021757549835', 'credit', 70, 120, 190, NULL, 'NGN', true, false, 4, NULL, '2025-09-11 00:17:15', '2025-09-11 00:17:15'),
  (16, 'App\Models\User', 1, 'App\Models\Order', 2, 'JARA_ORD_4323581757550172', 'credit', 5600, 16200, 21800, NULL, 'NGN', true, false, 3, NULL, '2025-09-11 00:22:52', '2025-09-11 00:22:52'),
  (17, 'App\Models\User', 2, 'App\Models\Order', 2, 'JARA_ORD_1969451757550172', 'credit', 70, 190, 260, NULL, 'NGN', true, false, 4, NULL, '2025-09-11 00:22:52', '2025-09-11 00:22:52'),
  (19, 'App\Models\User', 3, 'App\Models\Order', 10, 'JARA_ORD_4934631757615239', 'debit', 10000, 50000, 40000, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 17:27:19', '2025-09-11 17:27:19'),
  (20, 'App\Models\User', 3, 'App\Models\Order', 11, 'JARA_ORD_2922421757615638', 'debit', 10000, 40000, 30000, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 17:33:58', '2025-09-11 17:33:58'),
  (21, 'App\Models\User', 3, 'App\Models\Order', 12, 'JARA_ORD_4059571757626947', 'debit', 10000, 30000, 20000, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 20:42:27', '2025-09-11 20:42:27'),
  (22, 'App\Models\User', 3, 'App\Models\Order', 13, 'JARA_ORD_6741001757627502', 'debit', 10000, 20000, 10000, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 20:51:42', '2025-09-11 20:51:42'),
  (23, 'App\Models\User', 3, 'App\Models\Order', 14, 'JARA_ORD_3348561757627667', 'debit', 10000, 10000, 0, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 20:54:27', '2025-09-11 20:54:27'),
  (24, 'App\Models\User', 3, 'App\Models\Order', 15, 'JARA_ORD_2120951757627809', 'debit', 10000, 500000, 490000, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 20:56:49', '2025-09-11 20:56:49'),
  (25, 'App\Models\User', 3, 'App\Models\Order', 16, 'JARA_ORD_5364771757627968', 'debit', 10000, 490000, 480000, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 20:59:28', '2025-09-11 20:59:28'),
  (26, 'App\Models\User', 3, 'App\Models\Order', 17, 'JARA_ORD_3358271757628130', 'debit', 10000, 480000, 470000, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 21:02:10', '2025-09-11 21:02:10'),
  (28, 'App\Models\User', 3, 'App\Models\Order', 19, 'JARA_ORD_5628821757628284', 'debit', 10000, 470000, 460000, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 21:04:44', '2025-09-11 21:04:44'),
  (30, 'App\Models\User', 3, 'App\Models\Order', 21, 'JARA_ORD_5153731757629776', 'debit', 10000, 460000, 450000, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 21:29:36', '2025-09-11 21:29:36'),
  (31, 'App\Models\User', 3, 'App\Models\Order', 22, 'JARA_ORD_2736541757629905', 'debit', 10000, 450000, 440000, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 21:31:45', '2025-09-11 21:31:45'),
  (32, 'App\Models\User', 3, 'App\Models\Order', 23, 'JARA_ORD_5215631757631778', 'debit', 10000, 440000, 430000, NULL, 'NGN', false, false, 5, NULL, '2025-09-11 22:02:58', '2025-09-11 22:02:58'),
  (33, 'App\Models\User', 1, 'App\Models\Order', 23, 'JARA_ORD_1681271757631907', 'credit', 124, 21800, 21924, NULL, 'NGN', true, false, 3, NULL, '2025-09-11 22:05:07', '2025-09-11 22:05:07'),
  (34, 'App\Models\User', 3, NULL, NULL, 'JARA_ORD_7995771757677710', 'debit', 5000, 430000, 425000, NULL, 'NGN', false, false, 5, 'withdraw to bank', '2025-09-12 10:48:30', '2025-09-12 10:48:30'),
  (45, 'App\Models\User', 10, 'App\Models\Order', 34, 'JARA_ORD_7201191775233175', 'debit', 12500, 584000, 571500, NULL, 'NGN', false, false, 11, NULL, '2026-04-03 20:19:35', '2026-04-03 20:19:35'),
  (46, 'App\Models\User', 10, 'App\Models\Order', 35, 'JARA_ORD_9771071775243105', 'debit', 4200, 577500, 573300, NULL, 'NGN', false, false, 11, NULL, '2026-04-03 23:05:05', '2026-04-03 23:05:05'),
  (47, 'App\Models\User', 10, 'App\Models\Order', 36, 'JARA_ORD_9700451775243512', 'debit', 6500, 573300, 566800, NULL, 'NGN', false, false, 11, NULL, '2026-04-03 23:11:52', '2026-04-03 23:11:52'),
  (48, 'App\Models\User', 21, 'App\Models\Order', 37, 'JARA_ORD_3833961775247173', 'debit', 8000, 200000, 192000, NULL, 'NGN', false, false, 22, NULL, '2026-04-04 00:12:53', '2026-04-04 00:12:53'),
  (49, 'App\Models\User', 10, 'App\Models\Order', 38, 'JARA_ORD_5678921775310139', 'debit', 9500, 601800, 592300, NULL, 'NGN', false, false, 11, NULL, '2026-04-04 17:42:19', '2026-04-04 17:42:19'),
  (50, 'App\Models\User', 21, 'App\Models\Order', 39, 'JARA_ORD_7539591775489972', 'debit', 14500, 192000, 177500, NULL, 'NGN', false, false, 22, NULL, '2026-04-06 19:39:32', '2026-04-06 19:39:32'),
  (51, 'App\Models\User', 21, 'App\Models\Order', 40, 'JARA_ORD_3461861775514030', 'debit', 12000, 377500, 365500, NULL, 'NGN', false, false, 22, NULL, '2026-04-07 02:20:30', '2026-04-07 02:20:30'),
  (52, 'App\Models\User', 10, 'App\Models\Order', 41, 'JARA_ORD_9590871775577233', 'debit', 4000, 592300, 588300, NULL, 'NGN', false, false, 11, NULL, '2026-04-07 19:53:53', '2026-04-07 19:53:53'),
  (53, 'App\Models\User', 10, 'App\Models\Order', 42, 'JARA_ORD_3301721775919234', 'debit', 7500, 588300, 580800, NULL, 'NGN', false, false, 11, NULL, '2026-04-11 18:53:54', '2026-04-11 18:53:54'),
  (54, 'App\Models\User', 10, 'App\Models\Order', 43, 'JARA_ORD_7690911775931803', 'debit', 18000, 580800, 562800, NULL, 'NGN', false, false, 11, NULL, '2026-04-11 22:23:23', '2026-04-11 22:23:23'),
  (55, 'App\Models\User', 10, 'App\Models\Order', 44, 'JARA_ORD_3525521775932920', 'debit', 4000, 562800, 558800, NULL, 'NGN', false, false, 11, NULL, '2026-04-11 22:42:00', '2026-04-11 22:42:00'),
  (56, 'App\Models\User', 10, 'App\Models\Order', 45, 'JARA_ORD_3477851775933070', 'debit', 8900, 558800, 549900, NULL, 'NGN', false, false, 11, NULL, '2026-04-11 22:44:30', '2026-04-11 22:44:30');
...
INSERT INTO "order_items" ("id", "order_id", "product_id", "ingredient_id", "quantity", "price", "unit", "vendor_id", "vendor_at", "status", "assurance_user_id", "assurance_at", "pass_quality_assurance", "remark", "re_assigned", "amount", "vendor_amount", "commision", "referral", "referral_id", "created_at", "updated_at") VALUES
  (1, 2, 1, NULL, 3, 4000.00, NULL, 1, '2025-09-11 01:13:11', 'completed', 1, '2025-09-11 01:22:52', true, NULL, NULL, 0.00, 5600.00, 500.00, 70.00, -1, '2025-05-31 10:42:32', '2025-09-11 00:22:52'),
  (2, 2, NULL, 2, 2, 3000.00, 'kg', NULL, NULL, 'completed', 1, '2025-09-11 01:22:52', true, NULL, NULL, 0.00, 0.00, 0.00, 0.00, NULL, '2025-05-31 10:42:32', '2025-09-11 00:22:52'),
  ...
  (11, 7, 1, NULL, 3, 4000.00, NULL, NULL, NULL, 'completed', 1, '2025-09-11 01:02:38', true, NULL, NULL, 0.00, 0.00, 0.00, 0.00, NULL, '2025-05-31 11:08:33', '2025-09-11 00:02:38'),
  (12, 7, NULL, 2, 2, 3000.00, 'kg', NULL, NULL, 'completed', 1, '2025-09-11 01:02:38', true, NULL, NULL, 0.00, 5000.00, 500.00, 50.00, -1, '2025-05-31 11:08:33', '2025-09-11 00:02:38'),
  (13, 8, 7, 1, 1, 500.00, 'kg', NULL, NULL, 'completed', 1, '2025-09-11 00:43:29', true, NULL, NULL, 0.00, 0.00, 0.00, 0.00, NULL, '2025-06-02 09:05:07', '2025-09-10 23:43:29'),
  (14, 8, 7, 2, 1, 4000.00, 'kg', NULL, NULL, 'completed', 1, '2025-09-11 00:43:29', true, NULL, NULL, 0.00, 0.00, 0.00, 0.00, NULL, '2025-06-02 09:05:07', '2025-09-10 23:43:29'),
  (15, 8, 8, 1, 1, 500.00, 'kg', NULL, NULL, 'completed', 1, '2025-09-11 00:43:29', true, NULL, NULL, 0.00, 0.00, 0.00, 0.00, NULL, '2025-06-02 09:05:07', '2025-09-10 23:43:29'),
  (16, 8, 8, 2, 1, 4000.00, 'kg', -1, '2026-04-17 22:31:53', 'processing', 1, '2025-09-11 00:43:29', true, NULL, NULL, 0.00, 0.00, 0.00, 0.00, NULL, '2025-06-02 09:05:07', '2026-04-18 02:31:53'),
  (17, 8, NULL, 1, 2, 3000.00, 'kg', 1, '2025-06-02 16:04:37', 'completed', 1, '2025-09-11 00:43:29', true, NULL, NULL, 0.00, 0.00, 0.00, 0.00, NULL, '2025-06-02 09:05:07', '2025-09-10 23:43:29'),
  (18, 8, NULL, 2, 2, 3000.00, 'kg', 1, '2025-06-02 16:03:48', 'completed', 1, '2025-09-11 00:43:29', true, NULL, NULL, 0.00, 0.00, 0.00, 0.00, NULL, '2025-06-02 09:05:07', '2025-09-10 23:43:29'),
  ...
  (41, 23, 1, 1, 1, 500.00, 'kg', NULL, NULL, 'completed', 1, '2025-09-11 23:05:07', true, NULL, NULL, 500.00, 450.00, 50.00, 4.00, 1, '2025-09-11 22:02:58', '2025-09-11 22:05:07'),
  (42, 23, NULL, 1, 5, 3000.00, 'kg', NULL, NULL, 'completed', 1, '2025-09-11 23:05:07', true, NULL, NULL, 15000.00, 13500.00, 1500.00, 120.00, 1, '2025-09-11 22:02:58', '2025-09-11 22:05:07'),
  ...
  (130, 44, 20, 8, 1, 1000.00, 'por', -1, '2026-04-20 18:57:41', 'processing', NULL, NULL, NULL, NULL, NULL, 1000.00, 1000.00, 0.00, 0.00, NULL, '2026-04-11 22:42:00', '2026-04-20 22:57:41'),
...
-- order_item_logs: 2 rows
INSERT INTO "order_item_logs" ("id", "order_item_id", "vendor_id", "status", "changed_at", "created_at", "updated_at") VALUES
  (1, 16, -1, 'processing', '2026-04-18 02:31:53', '2026-04-18 02:31:53', '2026-04-18 02:31:53'),
  (2, 130, -1, 'processing', '2026-04-20 22:57:41', '2026-04-20 22:57:41', '2026-04-20 22:57:41');

-- Resync identity sequences after inserting explicit ids
...
SELECT setval(pg_get_serial_sequence('"bank_accounts"', 'id'), COALESCE((SELECT MAX(id) FROM "bank_accounts"), 1), true);
SELECT setval(pg_get_serial_sequence('"banks"', 'id'), COALESCE((SELECT MAX(id) FROM "banks"), 1), true);
SELECT setval(pg_get_serial_sequence('"category_types"', 'id'), COALESCE((SELECT MAX(id) FROM "category_types"), 1), true);
SELECT setval(pg_get_serial_sequence('"commissions"', 'id'), COALESCE((SELECT MAX(id) FROM "commissions"), 1), true);
SELECT setval(pg_get_serial_sequence('"countries"', 'id'), COALESCE((SELECT MAX(id) FROM "countries"), 1), true);
SELECT setval(pg_get_serial_sequence('"payment_logs"', 'id'), COALESCE((SELECT MAX(id) FROM "payment_logs"), 1), true);
...
SELECT setval(pg_get_serial_sequence('"transfers"', 'id'), COALESCE((SELECT MAX(id) FROM "transfers"), 1), true);
SELECT setval(pg_get_serial_sequence('"uoms"', 'id'), COALESCE((SELECT MAX(id) FROM "uoms"), 1), true);
SELECT setval(pg_get_serial_sequence('"user_otps"', 'id'), COALESCE((SELECT MAX(id) FROM "user_otps"), 1), true);
SELECT setval(pg_get_serial_sequence('"categories"', 'id'), COALESCE((SELECT MAX(id) FROM "categories"), 1), true);
SELECT setval(pg_get_serial_sequence('"states"', 'id'), COALESCE((SELECT MAX(id) FROM "states"), 1), true);
SELECT setval(pg_get_serial_sequence('"category_product"', 'id'), COALESCE((SELECT MAX(id) FROM "category_product"), 1), true);
SELECT setval(pg_get_serial_sequence('"ingredients"', 'id'), COALESCE((SELECT MAX(id) FROM "ingredients"), 1), true);
SELECT setval(pg_get_serial_sequence('"lgas"', 'id'), COALESCE((SELECT MAX(id) FROM "lgas"), 1), true);
SELECT setval(pg_get_serial_sequence('"product_state_prices"', 'id'), COALESCE((SELECT MAX(id) FROM "product_state_prices"), 1), true);
SELECT setval(pg_get_serial_sequence('"ingredient_product"', 'id'), COALESCE((SELECT MAX(id) FROM "ingredient_product"), 1), true);
SELECT setval(pg_get_serial_sequence('"ingredient_state_prices"', 'id'), COALESCE((SELECT MAX(id) FROM "ingredient_state_prices"), 1), true);
SELECT setval(pg_get_serial_sequence('"users"', 'id'), COALESCE((SELECT MAX(id) FROM "users"), 1), true);
SELECT setval(pg_get_serial_sequence('"addresses"', 'id'), COALESCE((SELECT MAX(id) FROM "addresses"), 1), true);
SELECT setval(pg_get_serial_sequence('"category_user"', 'id'), COALESCE((SELECT MAX(id) FROM "category_user"), 1), true);
SELECT setval(pg_get_serial_sequence('"help_tickets"', 'id'), COALESCE((SELECT MAX(id) FROM "help_tickets"), 1), true);
SELECT setval(pg_get_serial_sequence('"supports"', 'id'), COALESCE((SELECT MAX(id) FROM "supports"), 1), true);
SELECT setval(pg_get_serial_sequence('"user_permissions"', 'id'), COALESCE((SELECT MAX(id) FROM "user_permissions"), 1), true);
SELECT setval(pg_get_serial_sequence('"wallets"', 'id'), COALESCE((SELECT MAX(id) FROM "wallets"), 1), true);
SELECT setval(pg_get_serial_sequence('"orders"', 'id'), COALESCE((SELECT MAX(id) FROM "orders"), 1), true);
SELECT setval(pg_get_serial_sequence('"transaction_logs"', 'id'), COALESCE((SELECT MAX(id) FROM "transaction_logs"), 1), true);
SELECT setval(pg_get_serial_sequence('"order_items"', 'id'), COALESCE((SELECT MAX(id) FROM "order_items"), 1), true);
SELECT setval(pg_get_serial_sequence('"order_item_logs"', 'id'), COALESCE((SELECT MAX(id) FROM "order_item_logs"), 1), true);
